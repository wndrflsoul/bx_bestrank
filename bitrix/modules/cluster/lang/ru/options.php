...
$MESS['CLUSTER_OPTIONS_CACHE_TYPE_MEMCACHED'] = 'Memcached';
...
$MESS['REDIS_OPTIONS_FAILOVER_DISTRIBUTE_SLAVES'] = 'Распределять команды на чтение случайным образом между slave серверами';
$MESS['CLUSTER_OPTIONS_REDIS_TIMEOUT'] = 'Таймаут соединения, секунды (по умолчанию 0)';
$MESS['CLUSTER_OPTIONS_REDIS_READ_TIMEOUT'] = 'Таймаут чтения, секунды (по умолчанию 0)';
?>