...
$MESS["CLU_MEMCACHE_LIST_FLAG"] = "Состояние";
$MESS["CLU_MEMCACHE_LIST_STATUS"] = "Статус";
$MESS["CLU_MEMCACHE_LIST_WEIGHT"] = "Использовать (%)";
$MESS["CLU_MEMCACHE_LIST_HOST"] = "Сервер";
$MESS["CLU_MEMCACHE_LIST_EDIT"] = "Изменить";
$MESS["CLU_MEMCACHE_LIST_DELETE"] = "Удалить";
$MESS["CLU_MEMCACHE_LIST_DELETE_CONF"] = "Удалить подключение?";
$MESS["CLU_MEMCACHE_LIST_START_USING"] = "Начать использовать";
$MESS["CLU_MEMCACHE_LIST_STOP_USING"] = "Прекратить использовать";
$MESS["CLU_MEMCACHE_UPTIME"] = "время работы";
