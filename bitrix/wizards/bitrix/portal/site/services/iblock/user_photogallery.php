...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/company/gallery/index.php",
	Array(
		"USER_PHOTOGALLERY_IBLOCK_ID" => $iblockID,
		"WIZARD_PORTAL_ADMINISTRATION_GROUP" => WIZARD_PORTAL_ADMINISTRATION_GROUP
	)
);
?>
