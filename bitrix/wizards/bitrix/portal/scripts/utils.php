...
class WizardServices
{
	public static function GetTemplates($relativePath, $wizardRelativePath)
	{
		...
		while(($dirName = @readdir($handle)) !== false)
		{
			...
			if (file_exists($wizardAbsolutePath."/images/templates/".$dirName."/lang/".LANGUAGE_ID."/screen.gif"))
				$arTemplate["SCREENSHOT"] = $wizardAbsolutePath."/images/templates/".$dirName."/lang/".LANGUAGE_ID."/screen.gif";
